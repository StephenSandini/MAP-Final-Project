class Constant {
  ...
  static const ARG_COMMENTS_LIST = 'comments_list';
  static const ARG_DYNAMIC_LIST = 'dynamic_list';
  static const ARG_INDEX = 'index';
  static const ARG_ONE_COMMENT = 'one_comment';
  ...
  static const COMMENTS_LIST_COLLECTION = 'comments_list';

  static const ARG_DOWNLOADURL = 'downloadurl';
  static const ARG_FILENAME = 'filename';

  static const MIN_ML_CONFIDENCE = 0.7; //70%
}
