          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                  ...
                  children: [
                    Container(
                      height: MediaQuery.of(context).size.height *
                          .4, //40% of the actual screeen height
                      child: photo == null
                          ? Icon(
                              Icons.photo_library,
                              size: 250,
                ...
                TextFormField(
                  decoration: InputDecoration(
                    hintText: 'SharedWidth (comma separated email list)',
                  ),
                  autocorrect: false,
...
class _Controller {
  ...
  PhotoMemo tempMemo = PhotoMemo(); //Instance of PhotoMemo
  ...
  void save() async {
    ...
    try {
      ...
      state.render(() => state.progressMessage = null); //Message will disappear
      //Transfering Data to Firestore
      ...
      tempMemo.hascComments = 'false';
      String docId = await FirebaseController.addPhotoMemo(tempMemo);
      tempMemo.docId = docId;
      state.photoMemoList.insert(0, tempMemo); //Inserting at the first Index
      //Loading Complete
  ...
  void getPhoto(String src) async {
    try {
      ...
      state.render(() => state.photo = File(_imageFile.path)); //converts to File type
    } catch (e) {
      MyDialog.info(
